...
// Wrapper for calling Put Bucket Policy HTTP handler tests.
...
// Wrapper for calling Get Bucket Policy HTTP handler tests.
...
// Wrapper for calling Delete Bucket Policy HTTP handler tests.
